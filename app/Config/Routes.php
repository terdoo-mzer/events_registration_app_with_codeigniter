...
$routes->group('dashboard', function ($routes) {
    $routes->match(['get','post'],'check-in', 'CheckinController::checkin'); // This will be an endpoint for the js form
    $routes->get('all-records', 'DashboardController::allRecords');
